...
export default function LandingPage() {
  ...
  const [alreadyRaised, setAlreadyRaised] = useState(1890.06); // Change this number as needed
  const [progressPercent, setProgressPercent] = useState((1890.06 / RAISE_TARGET) * 100);

  // ✅ Countdown timer
  useEffect(() => {
    const targetDate = new Date("2025-11-06T17:29:59Z").getTime();
