...
export default function LandingPage() {
  ...
  const [alreadyRaised, setAlreadyRaised] = useState(7560.60); // Change this number as needed
  const [progressPercent, setProgressPercent] = useState((7560.60 / RAISE_TARGET) * 100);
