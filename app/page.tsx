...
export default function LandingPage() {
  ...
  const [alreadyRaised, setAlreadyRaised] = useState(10896.16) ; // Change this number as needed
  const [progressPercent, setProgressPercent] = useState((10896.16 / RAISE_TARGET) * 100);
