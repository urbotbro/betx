...
export default function LandingPage() {
  ...
  const [alreadyRaised, setAlreadyRaised] = useState(6396.16) ; // Change this number as needed
  const [progressPercent, setProgressPercent] = useState((6396.16 / RAISE_TARGET) * 100);
