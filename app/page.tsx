...
export default function LandingPage() {
  ...
  const [alreadyRaised, setAlreadyRaised] = useState(4060.66); // Change this number as needed
  const [progressPercent, setProgressPercent] = useState((4060.66 / RAISE_TARGET) * 100);
