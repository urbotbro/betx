...
export default function LandingPage() {
  ...
  const [alreadyRaised, setAlreadyRaised] = useState(11706.86); // Change this number as needed
  const [progressPercent, setProgressPercent] = useState((11706.86 / RAISE_TARGET) * 100);

  // ✅ Countdown timer
  useEffect(() => {
    const targetDate = new Date("2025-12-04T23:29:59Z").getTime();
