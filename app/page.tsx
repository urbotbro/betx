...
export default function LandingPage() {
  ...
  const [alreadyRaised, setAlreadyRaised] = useState(3360.06); // Change this number as needed
  const [progressPercent, setProgressPercent] = useState((3360.06 / RAISE_TARGET) * 100);
