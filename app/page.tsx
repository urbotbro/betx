...
export default function LandingPage() {
  ...
  const [alreadyRaised, setAlreadyRaised] = useState(9612.96); // Change this number as needed
  const [progressPercent, setProgressPercent] = useState((9612.96 / RAISE_TARGET) * 100);
