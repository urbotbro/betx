...
export default function LandingPage() {
  ...
  const [alreadyRaised, setAlreadyRaised] = useState(824.36); // Change this number as needed
  const [progressPercent, setProgressPercent] = useState((824.36 / RAISE_TARGET) * 100);
