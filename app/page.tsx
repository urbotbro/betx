...
export default function LandingPage() {
  ...
  const [alreadyRaised, setAlreadyRaised] = useState(5000.06); // Change this number as needed
  const [progressPercent, setProgressPercent] = useState((5000.06 / RAISE_TARGET) * 100);
