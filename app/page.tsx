...
export default function LandingPage() {
  ...
  const [alreadyRaised, setAlreadyRaised] = useState(8200.06); // Change this number as needed
  const [progressPercent, setProgressPercent] = useState((8200.06 / RAISE_TARGET) * 100);
