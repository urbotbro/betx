...
export default function LandingPage() {
  ...
  const [alreadyRaised, setAlreadyRaised] = useState(9000.16); // Change this number as needed
  const [progressPercent, setProgressPercent] = useState((9000.16 / RAISE_TARGET) * 100);
