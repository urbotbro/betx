...
export default function LandingPage() {
  ...
  const [alreadyRaised, setAlreadyRaised] = useState(10600.06); // Change this number as needed
  const [progressPercent, setProgressPercent] = useState((10600.06 / RAISE_TARGET) * 100);
