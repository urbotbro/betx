...
export default function BetPage() {
  ...
  /* ▶︎ placeBet — missing before, now added */
  const placeBet = () => {
    if (!user) {
      alert('Please sign up / log in first.');
      return;
  ...
  return (
    <div className={pageBg}>
      ...
      {/* Balances — prevent cut-off on mobile */}
      <div className="max-w-6xl mx-auto px-4 mt-4 md:mt-6 py-4">
        <div className="flex items-center gap-2 text-xs overflow-x-auto no-scrollbar">
          <span className="text-slate-300 mr-2 shrink-0">Balances:</span>
      ...
      <div className="max-w-6xl mx-auto px-4 pb-16 grid lg:grid-cols-3 gap-8">
        {/* Left: Deposit + Withdraw + Trending */}
        <div className="lg:col-span-1 space-y-6">
          ...
          {/* Withdraw (NEW) */}
          <WithdrawCard balances={balances} onWithdraw={demoWithdraw} disabled={!user} />
